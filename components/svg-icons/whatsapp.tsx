...
export function WhatsappFill(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      // CHANGED: Increased the size to 4rem for a bigger icon
      width="4rem" 
      height="4rem" 
      {...props}
    >
      <g fill="none" fillRule="evenodd">
        {/* These paths are typically used for copyright/attribution and are often invisible */}
