...
import { Sprout, ArrowDown, Package, Star, Shield } from "lucide-react"
  ...
  return (
    <section className="relative py-18 min-h-[70vh] flex items-center justify-center bg-gradient-to-br from-green-50 via-emerald-50/20 to-background overflow-hidden">
      ...
      <div className="container relative z-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl py-[20%] sm:py-[8%] mx-auto text-center space-y-8">
          ...
          >
            ...
            <span className="text-base font-semibold text-primary">Catálogo de Produtos</span>
          ...
          >
            Oferecemos uma linha completa de produtos agrícolas de alta qualidade, desenvolvidos com 
            <span className="font-semibold text-primary"> tecnologia de ponta</span> para maximizar a 
            produtividade e sustentabilidade do seu campo.
          </motion.p>
          ...
          >
            {[
              { icon: Star, value: "100+", label: "Produtos" },
              { icon: Shield, value: "Garantia", label: "Certificada" },
              { icon: Sprout, value: "Alta", label: "Germinação" },
              { icon: Package, value: "Entrega", label: "Rápida" }
            ].map((item, index) => (
              <motion.div
                key={item.label}
      ...
      >
        ...
        >
          <span className="text-sm text-muted-foreground font-medium">Explore Nossos Produtos</span>
